...
/**
 * @OA\Info(
 *     version=PLAYCAST_VERSION,
 *     title="PlayCast",
 *     description="PlayCast is a standalone, turnkey web radio management tool. Radio stations hosted by PlayCast expose a public API for viewing now playing data, making requests and more.",
 *     @OA\License(
 *         name="Apache 2.0",
 ...
 *
 * @OA\Server(
 *     description=PLAYCAST_API_NAME,
 *     url=PLAYCAST_API_URL
 * )
 *
 * @OA\ExternalDocumentation(
 *     description="PlayCast on GitHub",
