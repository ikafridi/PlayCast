...
class Environment
{
    ...
    public const DOCKER_REVISION = 'PLAYCAST_DC_REVISION';

    public const LANG = 'LANG';

    public const RELEASE_CHANNEL = 'PLAYCAST_VERSION';

    public const SFTP_PORT = 'PLAYCAST_SFTP_PORT';
    ...
    /**
     * @return string The parent directory the application is within, i.e. `/var/playcast`.
     */
    ...
    public function getDatabaseSettings(): array
    {
        return [
            ...
            'dbname' => $this->data[self::DB_NAME] ?? 'playcast',
            'user' => $this->data[self::DB_USER] ?? 'playcast',
