...
class Station implements Stringable, IdentifiableEntityInterface
{
    ...
    /** @OA\Property(example="https://demo.playcast.com/") */
    ...
    /** @OA\Property(example="/var/playcast/stations/playtest_radio") */
    #[ORM\Column(length: 255, nullable: true)]
    ...
    /**
     * Whether the station uses PlayCast to directly manage the AutoDJ or lets the backend handle it.
     */
