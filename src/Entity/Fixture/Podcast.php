...
class Podcast extends AbstractFixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $podcast->setLink('https://demo.playcast.com');
        $podcast->setLanguage('en');
        $podcast->setDescription('The unofficial testing podcast for the PlayCast development team.');
        $podcast->setAuthor('PlayCast');
        $podcast->setEmail('demo@playcast.com');
