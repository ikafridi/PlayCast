...
class PlayCastCentral
{
    protected const BASE_URL = 'https://central.playcast.com';
    ...
    /**
     * Ping the PlayCast Central server for updates and return them if there are any.
     *
     * @return mixed[]|null
     */
    ...
    /**
     * Ping the PlayCast Central server to retrieve this installation's likely public-facing IP.
     *
     * @param bool $cached
     */
