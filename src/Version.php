...
class Version
{
    ...
    public const FALLBACK_VERSION = '0.14.1';
    ...
    public const LATEST_COMPOSE_URL = 'https://raw.githubusercontent.com/ikafridi/PlayCast/main/docker-compose.sample.yml';

    public const UPDATE_URL = 'https://docs.playcast.com/en/getting-started/updates';
    public const CHANGELOG_URL = 'https://github.com/ikafridi/PlayCast/blob/main/CHANGELOG.md';
    // phpcs:enable
    ...
    public function getVersionText(): string
    {
        ...
        if (isset($details['tag'])) {
            $commitLink = 'https://github.com/ikafridi/PlayCast/commit/' . $details['commit'];
            $commitText = sprintf(
