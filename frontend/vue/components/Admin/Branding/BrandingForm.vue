                        ...
                        <b-row>
                            ...
                            <b-col md="6">
                                ...
                                <b-wrapped-form-group id="form_edit_hide_product_name"
                                    ...
                                    <template #description>
                                        <translate key="lang_form_edit_hide_product_name_desc">If selected, this will remove the PlayCast branding from public-facing pages.</translate>
                                    </template>
                                    <template #default="props">
                                        <b-form-checkbox :id="props.id" v-model="props.field.$model">
                                            <translate key="lang_form_edit_hide_product_name">Hide PlayCast Branding on Public Pages</translate>
                                        </b-form-checkbox>
                                    </template>
                                </b-wrapped-form-group>
                            </b-col>
                            ...
                            <b-wrapped-form-group class="col-md-6" id="form_edit_homepage_redirect_url"
                                ...
                                <template #description>
                                    <translate key="lang_form_edit_homepage_redirect_url_desc">If a visitor is not signed in and visits the PlayCast homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.</translate>
                                </template>
                            </b-wrapped-form-group>
