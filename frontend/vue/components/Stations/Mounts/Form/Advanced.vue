            ...
            <b-row class="mb-3">
                ...
                <b-wrapped-form-group class="col-md-12" id="edit_form_custom_listen_url"
                    ...
                    <template #description>
                        <translate key="lang_edit_form_custom_listen_url_desc">You can set a custom URL for this stream that PlayCast will use when referring to it. Leave empty to use the default value.</translate>
                    </template>
