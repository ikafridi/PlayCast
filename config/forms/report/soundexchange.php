    ...
    'elements' => [
        ...
        'report_details' => [
            ...
            [
                ...
                <ul>
                    <li>PlayCast assumes that your station fits SoundExchange Transmission Category A, "Eligible nonsubscription
                    ...
                    <li>The data collected by PlayCast meets the SoundExchange standard for Actual Total Performances (ATP)
                    ...
                    <li>Reporting requirements for SoundExchange may change at any time. PlayCast is non-commercial community-built
                    software and cannot guarantee that its reporting format will always be up-to-date.</li>
                    <li>You should always verify the report generated by PlayCast before sending it. In particular, either the ISRC
