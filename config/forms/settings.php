...
return [
    ...
    'groups' => [
        ...
        'system' => [
            ...
            'elements' => [
                ...
                'instance_name' => [
                    'text',
                    [
                        'label' => __('PlayCast Instance Name'),
                        'description' => __(
        ...
        'channels' => [
            'tab' => 'services',
            'legend' => __('PlayCast Update Checks'),
            ...
            'elements' => [
                ...
                'release_channel' => [
                    ...
                    [
                        ...
                        'description' => __(
                            ...
                            'https://docs.playcast.com/en/getting-started/updates/release-channels'
                        ),
                    ],
                ],
                ...
                'check_for_updates' => [
                    ...
                    [
                        ...
                        'description' => __('Show new releases within your update channel on the PlayCast homepage.'),
                        'default' => true,
                    ],
                ],
