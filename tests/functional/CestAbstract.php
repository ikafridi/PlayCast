...
abstract class CestAbstract
{
    ...
    protected string $login_username = 'playcast@playcast.com';
    protected string $login_password = 'PlayCastFunctionalTests!';
    ...
    protected function setupComplete(FunctionalTester $I): void
    {
        ...
        $user->setName('PlayCast Test User');
    ...
    protected function uploadTestSong(): Entity\StationMedia
    {
        ...
        $songSrc = '/var/playcast/www/resources/error.mp3';
